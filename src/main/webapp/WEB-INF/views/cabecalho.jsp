			...
			<div id="header-content">
				<nav id="main-nav" >
					...
					<security:authorize access="hasRole('ROLE_ADMIN')">
						...
						<li><a href="${s:mvcUrl('PSC#pedidos').build()}" rel="nofollow"><fmt:message key="menu.cadastro_pedidos"/></a></li>
						<li><a href="${s:mvcUrl('UC#listar').build()}" rel="nofollow"><fmt:message key="menu.lista_usuario"/></a></li>
					</security:authorize>
						<li>
